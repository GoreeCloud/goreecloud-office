...
- Dependency-free native package identity, archive-entry path safety, Writer v1 package-structure/resource-limit validation, and decoded Writer manifest/content semantic validation.
